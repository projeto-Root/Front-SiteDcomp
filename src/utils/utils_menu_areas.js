...
export const dataMenuAreas = [
    ...
    content: [
      {
        ...
        img: '',
        topic: 'O que é?',
        content: 'A composição de cenas com alto grau de realismo sempre foi um forte tema de pesquisa em Computação Gráfica. Muitas vezes, gerar cenas naturais requer uma compreensão prévia dos agentes que alteram a aparência do ambiente e de como integrá-los a efeitos processados no computador. Uma das prioridades na Aquisição e Modelagem de Aparência consiste em gerar cenas com uma ótima qualidade e fidelidade visual ao mundo real. Mesmo que certas cenas renderizadas pareçam bem coerentes na simulação de efeitos fundamentais como iluminação, sombras e reflexão, muitas vezes é necessário incluir determinadas “imperfeições” para tornar os resultados mais naturais. A adição de imperfeições melhora a percepção final de uma imagem como natural.',
      },
      {
        topic: 'Por que estudar Aquisição e Modelagem de Aparência?',
        content: 'Como a variação de aparência de materiais normalmente está associada à influências físicas e químicas do ambiente, a tarefa de modelar tais efeitos não costuma ser trivial. Fenômenos como o apodrecimento de frutas e a corrosão de metais abrangem toda uma gama de características físicas e químicas determinantes na alteração visual do material em questão. A modelagem também consiste na capacidade de garantir que a informação digital permaneça acessível e com qualidades de autenticidade suficientes para que possa ser interpretada no futuro recorrendo a uma plataforma tecnológica diferente da do momento da sua criação, tendo assim um papel também de preservação histórica.',
        video: ''
      }
    ]
  },
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content: 'É essencial que todos profissionais da Computação tenham pelo menos conhecimentos básicos de Arquitetura de Computadores. Saber como o computador funciona nos permitirá entender sua capacidade (e incapacidade) de resolver problemas, sobre como programá-los da melhor forma possível, como deixar o computador e os dados contidos neles mais seguros, como ganhar desempenho e o que faz ele ficar tão lento.',
    ...
    content: [
      {
        ...
        img: '',
        topic: 'O que é?',
        content: 'Um banco de dados é uma coleção organizada de informações - ou dados - estruturadas, normalmente armazenadas eletronicamente em um sistema de computador. Um banco de dados é geralmente controlado por um sistema de gerenciamento de banco de dados DBMS. Juntos, os dados e o DBMS, juntamente com os aplicativos associados a eles, são chamados de sistema de banco de dados, geralmente abreviados para apenas banco de dados. Os dados nos tipos mais comuns de bancos de dados em operação atualmente são modelados em linhas e colunas em uma série de tabelas para tornar o processamento e a consulta de dados eficientes. Os dados podem ser facilmente acessados, gerenciados, modificados, atualizados, controlados e organizados. A maioria dos bancos de dados usa a linguagem de consulta estruturada SQL para escrever e consultar dados.',
      },
      {
        topic: 'O que faz um profissional da área?',
        content: 'Um profissional de análise de banco de dados é quem faz a administração dos servidores, acompanhamento de desempenho, programação de rotina, além de garantir a segurança de acesso. Este colaborador também cuidará de alguns dos KPIs estabelecidos pela empresa, identificando e solucionando determinados problemas.',
        video: 'https://www.youtube.com/watch?v=ovnliKtbt0M&ab_channel=DevMedia'
      }
    ]
  },
  {
    ...
    content: [
      {
        ...
        img: '',
        topic: 'O que é?',
        content: 'A computação gráfica é a área da computação destinada à geração de imagens em geral em forma de representação de dados e informação, ou em forma de arte e recriação do mundo real. Ela pode possuir uma infinidade de aplicações para diversas áreas, desde a própria informática, ao produzir interfaces gráficas para software, sistemas operacionais e sites na Internet, quanto para produzir animações e jogos. É muito utilizada na indústria do entretenimento, engenharia, arquitetura, design, pesquisa científica e na área de comunicação.',
      },
      {
        topic: 'O que faz um profissional da área?',
        content: 'Quem atua no ramo da Computação Gráfica consegue desenvolver trabalhos de duas ou mais dimensões, simuladores digitais, maquetes eletrônicas e animação e educação de áudio e vídeo sendo um profissional indispensável em diferentes níveis do mercado de trabalho.',
        video: 'https://www.youtube.com/watch?v=-4_OU95nKuU&ab_channel=Nerdologia'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        topic: 'O que faz um profissional da área?',
        content: '',
        video: 'https://www.youtube.com/watch?app=desktop&v=uUCGKJni7Nk&ab_channel=Refatorando'
      }
    ]
  },
  {
    ...
    content: [
      {
        ...
        img: '',
        topic: 'O que é?',
        content: 'É a utilização de recursos computacionais, hardware e software, no processo ensino-aprendizagem. É a informática utilizada como recurso adicional, a serviço do professor e do aluno, independentemente da disciplina. Portanto, não é a substituição do professor por recursos tecnológicos, vez que o professor permanece como o principal ator do processo. Não existem regras de como aplicar a informática na educação, mas alguns fatores são determinantes para a obtenção de resultados positivos, como criatividade, planejamento, domínio de informática e tecnologias.',
      },
      {
        topic: 'O que um profissional em Informática Educativa faz?',
        content: 'Basicamente um profissional focado na área de Informática Educativa, faz uma coligação entre a parte retrógrada de ensino com o avanço da tecnologia onde, com o auxílio das novas tecnologias, seria bem mais fácil transmitir certos tipos de conteúdo em uma sala de aula,e que com isso melhoria gradativamente o aprendizado do estudante em todos os aspectos.',
        video: 'https://www.youtube.com/watch?v=OKba9et2t2I&ab_channel=ELIANEALIRA'
      }
    ]
  },
  {
    ...
    content: [
      ...
      {
        topic: 'O que faz um profissional da área?',
        content: 'Um profissional da área de eHealth pode trabalhar em diversos tópicos, alguns deles são: desenvolvimento de sistemas de informação em saúde, telemedicina, processamento de imagens médicas, processamento de sinais biológicos e outros.',
        video: ''
      }
    ]
  },
    ...
    content: [
      {
        ...
        img: '',
        topic: 'O que é?',
        content: 'A Modelagem e Simulação de Sistemas Computacionais permite representar Sistemas Computacionais por meio de modelos de simulação e reproduzir suas cadeias de causalidade, estimar e avaliar resultados e subsidiar o processo de tomada de decisões em nível de engenharia.',
      },
      {
        topic: 'O que faz um profissional da área?',
        ...
        video: 'https://www.youtube.com/watch?v=97907MOrXZI&ab_channel=WilsonCastello'
      }
    ]
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      {
        topic: 'O que faz um profissional da área?',
        content: 'Um profissional da área tem como objetivo a solução dos problemas de otimização multiobjetivo que consiste em determinar, no Espaço Objetivo Factível, o Conjunto Eficiente, um Subconjunto do Conjunto Eficiente ou ainda, Conjuntos de soluções próximas da Fronteira Pareto-Ótima. O tamanho e a complexidade dos métodos de solução encontrados em grande parte dos problemas práticos exige a intervenção de um Tomador de Decisão.',
        video: 'https://www.youtube.com/watch?v=R3wzECA3tDI&ab_channel=AneirsonSilva'
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        content: '',
        video: 'https://www.youtube.com/watch?v=vbtErRXkHqg&ab_channel=IAExpertAcademy'
      }
    ]
  },
  {
    ...
    content: [
      ...
      },
      {
        topic: 'O que faz um profissional da área?',
        content: '',
        video: 'https://www.youtube.com/watch?v=T9V_axU6jU8&ab_channel=ProgramaçãoDinâmica'
      }
    ]
  },
  {
    ...
    content: [
      {
        ...
        img: '',
        topic: 'O que é?',
        content: 'A teoria da computação é um subcampo da ciência da computação e matemática que busca determinar quais problemas podem ser computados em um dado modelo de computação. A computação pode ser definida como a solução de um problema ou, formalmente, o cálculo de uma função por meio de um algoritmo.',
      },
      {
        topic: 'O que faz um profissional da área?',
        content: 'O cientista da computação estuda os princípios e fundamentos da computação teórica aplicada e a sua interação com o mundo real. Seu foco é construir softwares e desenvolver algoritmos, modelos computacionais e teorias computacionais para melhorar e empoderar a sociedade e os negócios.',
        video: 'https://www.youtube.com/watch?v=H_d9uGc_K2c&ab_channel=AulasdeComputação'
      }
    ]
  },
  {
