...
const Representations = ({ title, image, projects, members }) => {
  const [orderMembers, setOrderMembers] = useState(members);
  ...
  return (
    ...
    >
      <LogoGroup src={image}></LogoGroup>
      <h1 style={{ marginTop: "1rem", color: "#222" }}>
        O que é {title.toUpperCase()}
      </h1>
      <section
        style={{
          width: "100%",
      ...
      <section>
        ...
        <div style={{ maxWidth: "30rem", width: "auto", margin: "4rem", display: "flex", justifyContent: "center", alignItems: "center", gap: "1rem" }}>
